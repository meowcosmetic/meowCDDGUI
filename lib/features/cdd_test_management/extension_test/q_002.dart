...
class _ExtensionTestQ002State extends State<ExtensionTestQ002> {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Đánh giá chi tiết - Hành vi lờ âm thanh và người khác',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: pathColor,
  ...
  void _processResults() {
    // Đếm số câu trả lời "Có" (có lờ âm thanh/người khác)
    int yesCount = 0;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _buildStatCard(
                        'Không lờ âm thanh/người khác',
                        '${assessmentQuestions.length - yesCount}/${assessmentQuestions.length}',
                        Colors.green,
                        Icons.check_circle,
                      ),
                    ),
