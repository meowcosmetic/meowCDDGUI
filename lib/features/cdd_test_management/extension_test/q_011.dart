...
class ExtensionTestQ011 extends StatefulWidget {
  const ExtensionTestQ011({Key? key}) : super(key: key);

  @override
  State<ExtensionTestQ011> createState() => _ExtensionTestQ011State();
}
...
class _ExtensionTestQ011State extends State<ExtensionTestQ011> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Extension Test - Câu hỏi 11'),
