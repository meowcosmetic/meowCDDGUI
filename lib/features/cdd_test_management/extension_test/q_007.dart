...
class ExtensionTestQ007 extends StatefulWidget {
  const ExtensionTestQ007({Key? key}) : super(key: key);
...
class _ExtensionTestQ007State extends State<ExtensionTestQ007> {
  ...
  final String question = "Con bạn có thường xuyên nhìn chằm chằm vào một vật thể trong thời gian dài không?";
  
  final List<String> options = [
    "A. Có, con thường nhìn chằm chằm rất lâu",
    "B. Thỉnh thoảng con có hành vi này",
    "C. Con hiếm khi nhìn chằm chằm",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Extension Test - Câu hỏi 7'),
