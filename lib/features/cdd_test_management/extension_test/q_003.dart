...
class _ExtensionTestQ003State extends State<ExtensionTestQ003> {
  ...
  final List<Map<String, String>> pretendPlayQuestions = [
    ...
    {
      'id': 'pretend_3',
      'question': 'Giả vờ nói chuyện điện thoại chưa?',
    },
    {
      'id': 'pretend_4',
      'question': 'Giả vờ cho búp bê hoặc thú nhồi bông ăn thức ăn thật hoặc tưởng tượng chưa?',
    },
    {
      'id': 'pretend_5',
      'question': 'Đẩy 1 cái xe như thể nó đang đi trên 1 con đường giả vờ chưa?',
    },
    {
      'id': 'pretend_6',
      'question': 'Giả vờ là một người, một máy bay, một nữ diễn viên ballet hoặc bất kỳ nhân vật yêu thích nào chưa?',
    },
    {
      'id': 'pretend_7',
    ...
    {
      'id': 'pretend_8',
      'question': 'Giả vờ khuấy thứ gì đó chưa?',
    },
    {
      'id': 'pretend_9',
      'question': 'Đặt một vật hoặc con búp bê vào một chiếc xe hơi hoặc xe tải như thể nó là người lái xe hoặc hành khách chưa?',
    },
    {
      'id': 'pretend_10',
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              hintText: 'Nhập mô tả khác về khả năng chơi giả vờ của con bạn...',
  ...
  void _processResults() {
    ...
    if (hasAnyYes) {
      ...
      _setFinalResult(false, 'KHÔNG ĐẠT - Con bạn chưa có khả năng chơi giả vờ');
    }
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      finalResult! ? 'ĐẠT - Con bạn có khả năng chơi giả vờ tốt' : 'KHÔNG ĐẠT - Con bạn cần hỗ trợ phát triển khả năng chơi giả vờ',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                        color: finalResult! ? Colors.green : Colors.red,
