...
class AppConfig {
  ...
  static const bool showInterventionMethods =
      true; // Nhóm phương pháp can thiệp
  ...
  static const bool enableAddTestCategory =
      true; // Bật nút thêm category bài test
  static const bool enableInterventions =
      true; // Bật tính năng mục tiêu can thiệp
  static const bool enableInterventionDomains =
      true; // Bật tính năng lĩnh vực can thiệp
  static const bool enableInterventionMethods =
      true; // Bật tính năng nhóm phương pháp can thiệp
  ...
  static const bool requireBiometricAuth =
      false; // Yêu cầu xác thực sinh trắc học
