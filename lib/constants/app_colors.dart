...
class AppColors {
  ...
  static Color get alertSuccessShadow => alertSuccessBorder.withValues(alpha: 0.1);
  ...
  static Color get alertWarningShadow => alertWarningBorder.withValues(alpha: 0.1);
